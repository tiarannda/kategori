...
<head>
    ...
    <title>iCare Service - Data Barang</title>
    ...
    <style>
        ...
        .sidebar .logo a.simple-text.logo-normal {
            ...
            font-weight: bold; /* Opsional, memberikan efek tebal */
        }
...
<body>
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand custom-title" href="#">Data Barang</a>
                    </div>
                </div>
            </nav>
            <!-- End Navbar -->
            ...
            <!-- Content -->
            <div class="content">
                <h1 class="custom-title">Data Barang</h1>
